...
Simulate_Population_Data = function(prob_disease, causal_region, N1, equifrequent_cSNV, Beta0, Beta ){
  ...
  while(simulation.stop.cond == FALSE){
    ...
    # For example, in this case we stop the simulation if the number of indiviudals carrying one copy of cSNV are either
    # 155, 154, 153, or 152.
    if( cSNV_Carrier_Frequency[2] %in% c( (N1-3):N1 ) ){
