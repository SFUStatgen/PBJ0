...
#SBATCH --time=03:00:00       # time (HH:MM:SS) - run time per processor; changed from 2days to 2h!
...
export R_LIBS=/home/pnickchi/R/x86_64-pc-linux-gnu-library/3.5 #This will need to be changed to your compute canada account info
